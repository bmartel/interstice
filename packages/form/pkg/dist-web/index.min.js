import{html,LitElement,css}from"lit-element";import{classMap}from"lit-html/directives/class-map";import{spread}from"@open-wc/lit-helpers";const fontStyles=html`
  <style>
    :host {
...
`;class FormInput extends LitElement{static get properties(){return{id:{type:String},name:{type:String},type:{type:String},value:{type:String},label:{type:String},hint:{type:String},placeholder:{type:String},messages:{type:Array},wide:{type:Boolean},inline:{type:Boolean},reversed:{type:Boolean},disabled:{type:Boolean},readonly:{type:Boolean},status:{type:String}}}static get styles(){return css`
      :host {
        display: inline-flex;
      }
      .input-wrapper {
    ...
    `}renderOption(e,t){const{inline:r,reversed:i,wide:s,...o}=e;return html`
      <i-checkbox
        .name=${this.name}
        .id=${this.inputId(t)}
    ...
    `}constructor(){super(),this.value=""}inputUpdate(e){this.value=e.target.value}inputSelected(e){return this.value===this.convertValue(e)}renderOption(e,t){const{inline:r,reversed:i,wide:s,...o}=e;return html`
      <i-radio
        .name=${this.name}
        .id=${this.inputId(t)}
        .label=${this.convertLabel(e)}
        ...
        ...=${spread(o)}
      ></i-radio>
    `}}customElements.define("i-radiogroup",RadioGroup);export{CheckBox,CheckBoxGroup,FormInput,FormSelect,Radio,RadioGroup,Range,TextArea,TextField};
