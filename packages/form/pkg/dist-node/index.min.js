"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var litElement=require("lit-element"),classMap=require("lit-html/directives/class-map"),litHelpers=require("@open-wc/lit-helpers");const fontStyles=litElement.html`
  <style>
    :host {
...
`;class FormInput extends litElement.LitElement{static get properties(){return{id:{type:String},name:{type:String},type:{type:String},value:{type:String},label:{type:String},hint:{type:String},placeholder:{type:String},messages:{type:Array},wide:{type:Boolean},inline:{type:Boolean},reversed:{type:Boolean},disabled:{type:Boolean},readonly:{type:Boolean},status:{type:String}}}static get styles(){return litElement.css`
      :host {
        display: inline-flex;
      }
      .input-wrapper {
    ...
    `}constructor(){super(),this.value=""}inputUpdate(e){this.value=e.target.value}inputSelected(e){return this.value===this.convertValue(e)}renderOption(e,t){const r=_objectWithoutProperties(e,["inline","reversed","wide"]);return litElement.html`
      <i-radio
        ...
        ...=${litHelpers.spread(r)}
      ></i-radio>
    `}}customElements.define("i-radiogroup",RadioGroup),exports.CheckBox=CheckBox,exports.CheckBoxGroup=CheckBoxGroup,exports.FormInput=FormInput,exports.FormSelect=FormSelect,exports.Radio=Radio,exports.RadioGroup=RadioGroup,exports.Range=Range,exports.TextArea=TextArea,exports.TextField=TextField;
